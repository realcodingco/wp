...
function initAuth(fn) {
  const firebaseConfig = {
    apiKey: "AIzaSyCVyumZZQrCsJp6DkPZqf9lrqq4HCzJF0Y",
    authDomain: "rcwp-684a7.firebaseapp.com",
    projectId: "rcwp-684a7",
    storageBucket: "rcwp-684a7.appspot.com",
    messagingSenderId: "779061534644",
    appId: "1:779061534644:web:f90679ae18918396879ce1",
    measurementId: "G-RG8RR0X97S"
  };
  if(!bsb) {
...
function getThemepkURL(callback) {
  bsb.firestore().collection("bsbAdmin").doc('theme').get().then(doc => { 
    callback(doc.data()? doc.data().url : null); 
  });
}
